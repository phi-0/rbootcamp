...
#Viel zu viele Werte, Durchschnittswerte pro Tag für Temperatur und Count nehmen?
...
As we are looking at count data it makes sense to use a generalised linear model in order to specify the distribution of our data as a poisson distribution. 
